 ...
 extension FeedStoreSpecs where Self: XCTestCase {
 	...
 	func expect(_ sut: FeedStore, toRetrieve expectedResult: FeedStore.RetrievalResult, file: StaticString = #file, line: UInt = #line) {
 		...
 		sut.retrieve { retrievedResult in
            ...
            case let (.success(.found(expectedFeed, expectedTimeStamp)), .success(.found(retreivedFeed, retreivedTimeStamp))):
                XCTAssertEqual(retreivedFeed, expectedFeed, file: file, line: line)
                XCTAssertEqual(retreivedTimeStamp, expectedTimeStamp, file: file, line: line)
